...
function useSettingsInternal() {
  ...
  return {
    ...
    setFunasrModel: store.setFunasrModel,
    ...
    funasrVadEnabled: store.funasrVadEnabled,
    setFunasrVadEnabled: store.setFunasrVadEnabled,
    funasrVadThreshold: store.funasrVadThreshold,
    setFunasrVadThreshold: store.setFunasrVadThreshold,
    funasrVadMinSpeechDurationMs: store.funasrVadMinSpeechDurationMs,
    setFunasrVadMinSpeechDurationMs: store.setFunasrVadMinSpeechDurationMs,
    funasrVadMinSilenceDurationMs: store.funasrVadMinSilenceDurationMs,
    setFunasrVadMinSilenceDurationMs: store.setFunasrVadMinSilenceDurationMs,
    funasrVadMaxSpeechDurationS: store.funasrVadMaxSpeechDurationS,
    setFunasrVadMaxSpeechDurationS: store.setFunasrVadMaxSpeechDurationS,
    funasrVadSpeechPadMs: store.funasrVadSpeechPadMs,
    setFunasrVadSpeechPadMs: store.setFunasrVadSpeechPadMs,
